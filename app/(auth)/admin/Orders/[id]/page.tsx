...
export default function AdminOrderDetailPage() {
  ...
  const handleStatusChange = async (newStatus: string) => {
    ...
    try {
      await api.put(`${ORDERS_API_URL}/${order.id}/status`, {
        status: newStatus,
      });
  ...
  if (notFound || error) {
    return (
      ...
      >
        ...
        <Button size="lg" onClick={() => router.push("/admin/Orders")}>
          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <select
                ...
                className="rounded-lg border border-border/50 bg-background/60 px-3 py-2 text-sm outline-none disabled:opacity-50"
              >
